...
from fairseq.data import BinarizedAudioDataset
from fairseq.dataclass import FairseqDataclass, ChoiceEnum
from fairseq.data.text_compressor import TextCompressionLevel

from fairseq.tasks import FairseqTask, register_task

from ..data import Wav2vecFbankDataset
...
class Wav2VecCriterionConfig(FairseqDataclass):
    ...
    stats_npz_path: Optional[str] = field(
        default=None,
        metadata={"help": "path to precomputed normalization statistics"},
    )
...
@register_task("audio_fbank_pretraining", dataclass=Wav2VecCriterionConfig)
class AudioPretrainingFBankTask(FairseqTask):
    """ """

    cfg: Wav2VecCriterionConfig

    @classmethod
    def setup_task(cls, cfg: Wav2VecCriterionConfig, **kwargs):
        """Setup the task (e.g., load dictionaries).

        Args:
            cfg (Wav2VecCriterionConfig): configuration of this task
        """
    ...
    def load_dataset(self, split: str, task_cfg: FairseqDataclass = None, **kwargs):
        ...
        if getattr(task_cfg, "binarized_dataset", False):
            ...
            self.datasets[split] = Wav2vecFbankDataset(
