...
TASK_DATA=${FAIRSEQ_ROOT}/examples/wav2vec/manifest-u/timit/unmatched/feat/precompute_pca512_cls128_mean_pooled
TEXT_DATA=${FAIRSEQ_ROOT}/examples/wav2vec/manifest-u/timit/unmatched/phones  
KENLM_PATH=${FAIRSEQ_ROOT}/examples/wav2vec/manifest-u/timit/unmatched/phones/train_text_phn.04.bin
output_dir=${work_dir}/outputs/timit/unmatched/seed$1
...
for code in ${code_penalty}; do
    for gradient in ${gradient_penalty}; do
        for smooth in ${smoothness_weights}; do
            ...
            common.wandb_project=w2vu-timit-unmatched \
