...
TASK_DATA=$manifest/timit/unmatched/feat/precompute_pca512_cls128_mean_pooled
TEXT_DATA=$manifest/timit/unmatched/phones  
KENLM_PATH=$manifest/timit/unmatched/phones/train_text_phn.04.bin
output_dir=${FAIRSEQ_ROOT}/outputs/w2vu/timit/unmatched/seed$1
