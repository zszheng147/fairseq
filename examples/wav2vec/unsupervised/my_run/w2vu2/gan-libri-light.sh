...
TASK_DATA=${FAIRSEQ_ROOT}/examples/wav2vec/manifest-u2/processed_audio_10h
TEXT_DATA=${FAIRSEQ_ROOT}/examples/wav2vec/manifest-u2/processed_text/phones
KENLM_PATH=${FAIRSEQ_ROOT}/examples/wav2vec/manifest-u2/processed_text/phones/lm.phones.filtered.04.bin
output_dir=${FAIRSEQ_ROOT}/outputs/w2vu2/libri-light/seed$1
