...
task_data=/userhome/user/zsz01/data/manifest-u2/processed-feat-960h
ckpt=${ckpt_root}/librispeech-960h
run_dir=${FAIRSEQ_ROOT}/transcriptions/w2vu2/librispeech-960h
