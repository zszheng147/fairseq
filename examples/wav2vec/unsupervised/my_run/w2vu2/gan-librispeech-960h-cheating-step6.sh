...
KENLM_PATH=$manifest/processed-lm-from-librispeech/phones/lm_nooverlap_librispeech_unique_4gram_200kvocab.bin
output_dir=${FAIRSEQ_ROOT}/outputs/w2vu2/librispeech-960h-cheating-noaux/seed$1
...
#             fi
            ...
            --config-dir config/gan --config-name w2vu2-step6 \
            task.data=${TASK_DATA} \
            ...
            common.wandb_project=w2vu2-librispeech-960h-cheating \
