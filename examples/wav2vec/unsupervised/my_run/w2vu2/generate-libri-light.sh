...
task_data=/userhome/user/zsz01/data/manifest-u2/processed-feat-10h
ckpt=${ckpt_root}/audio-ll10-text-ls960
run_dir=${FAIRSEQ_ROOT}/transcriptions/w2vu2/libri-light
