...
TEXT_DATA=$manifest/raw-openslr-30k/phones
KENLM_PATH=$manifest/raw-openslr-30k/phones/lm.phones.filtered.04.bin
output_dir=${FAIRSEQ_ROOT}/outputs/w2vu2/librispeech-960h-openslr-30k-re/seed$1
