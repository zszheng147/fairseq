...
TEXT_DATA=$manifest/raw-openslr-0.3m/phones
KENLM_PATH=$manifest/raw-openslr-0.3m/phones/lm.phones.filtered.04.bin
output_dir=${FAIRSEQ_ROOT}/outputs/w2vu2/librispeech-960h-raw-openslr-0.3m/seed$1
