...
TEXT_DATA=$manifest/raw-librivox-noSpace/phones
KENLM_PATH=$manifest/raw-librivox-noSpace/phones/lm.phones.filtered.06.bin
output_dir=${FAIRSEQ_ROOT}/outputs/w2vu2/librispeech-960h-raw-noSpace/seed$1
