...
TEXT_DATA=$manifest/raw-librispeech/phones
KENLM_PATH=$manifest/raw-librispeech/phones/lm.phones.filtered.04.bin
output_dir=${FAIRSEQ_ROOT}/outputs/w2vu2/librispeech-960h-raw-librispeech/seed$1
