...
TEXT_DATA=$manifest/raw-librivox/phones
KENLM_PATH=$manifest/raw-librivox/phones/lm.phones.filtered.04.bin
output_dir=${FAIRSEQ_ROOT}/outputs/w2vu2/librispeech-960h-raw-librivox/seed$1
