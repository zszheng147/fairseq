...
TEXT_DATA=$manifest/raw-openslr/phones
KENLM_PATH=$manifest/raw-openslr/phones/lm.phones.filtered.04.bin
output_dir=${FAIRSEQ_ROOT}/outputs/w2vu2/librispeech-960h-raw-openslr/seed$1
