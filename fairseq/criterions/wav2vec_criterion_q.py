...
@dataclass
class Wav2VecQCriterionConfig(FairseqDataclass):
    infonce: bool = field(
        default=False,
        metadata={
...
@register_criterion("wav2vec_q", dataclass=Wav2VecQCriterionConfig)
class Wav2vecQCriterion(FairseqCriterion):
